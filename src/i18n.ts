...
export const translations = {
  en: {
    translation: {
      ...
      settings: {
        ...
        noImageMode: "Hide clues for more of a challenge.",
      ...
      install: {
        ...
        description: "Add Urble to Home Screen to play it easily!",
  ...
  fr: {
    translation: {
      ...
      welldone: "Bien joué !",
      unknownCity: "Pays inconnu !",
      copy: "Résultat copié !",
      showCity: "🗺️ Afficher la carte !",
      ...
      install: {
        ...
        description:
          "Ajouter Urble sur l'écran d'accueil pour le retrouver plus facilement !",
        instructionTitle: "Instructions :",
        instructionActionOk: "OK",
  ...
  es: {
    translation: {
      ...
      welldone: "Bien hecho !",
      unknownCity: "País desconocido !",
      copy: "Resultado copiado !",
      showCity: "🗺️ mostrar mapa !",
  ...
  eu: {
    translation: {
      ...
      welldone: "Ongi egina !",
      unknownCity: "Estatu ezezaguna !",
      copy: "Emaitzak arbelean kopiatuta !",
      showCity: "🗺️ Erakutsi mapan !",
  ...
  hu: {
    translation: {
      ...
      install: {
        ...
        description:
          "Add hozzá a Urble a Kezdőképernyőhöz, hogy egyszerűbben játszhass!",
        instructionTitle: "In",
        instructionActionOk: "OK",
  ...
  nl: {
    translation: {
      ...
      install: {
        ...
        description:
          "Voeg Urble toe aan je beginscherm om het makkelijk te spelen!",
