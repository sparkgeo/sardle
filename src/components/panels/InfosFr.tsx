  ...
  return (
    <Panel title="Comment jouer" isOpen={isOpen} close={close}>
      ...
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3 font-bold">
        Un nouveau <Urble /> sera disponible chaque jour !
      </div>
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3">
        ...
        <div>
          ...
          <a
            className="underline"
            href="https://Urble.notion.site/Urble-4005ca16fc9341e7be8adcfd30628146"
            target="_blank"
      ...
      <div className="space-y-3 text-justify border-b-2 border-gray-200 pb-3 mb-3">
        <Urble /> a été <span className="font-bold">très</span> inspiré par{" "}
        <a
          className="underline"
